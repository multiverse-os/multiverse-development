...
mod tests {
    ...
    const TEST_INSTANCE_ID: &str = "TEST-PORTAL-ID";
    const TEST_APP_NAME: &str = "Portal";
    const TEST_APP_VERSION: &str = "0.1.0";
    ...
    fn validate_logs(
        ...
        // The first line should contain the portal version.
