...
## development stage provisioning file. It does not yet
## contain more logic than running apt-get update && 
## apt-get upgrade. Which post-install will have already
## been done by the netinstall. 
##
...
## TODO:
## Refer to the newly upgraded universe router provision script, which contains
## newly added code for two operating modes: standard which copies the base
## files directly to the system, and 
##
###############################################################################
...
## TODO: Put in information here about operating mode; for example, standard vs development
##       and other global information or prompt input/questions for the user to guide the
##       installation if a completed YAML configuration is not supplied. 
