...
iso_filename="Fedora-Workstation-Live-x86_64-27-1.6.iso"
checksum_filename="Fedora-Workstation-27-1.6-x86_64-CHECKSUM"
start_dir=$(pwd)

echo -e $header"Fedora Workstation 27-1.6 x86_64"$reset
echo -e $accent"=================="$reset
echo -e $text"Downloading and verifying$header Fedora Workstation 27-1.6$text Live CD ISO image..."$reset
