...
echo -e $header"Debian 9.4.0 amd64"$reset
echo -e $accent"=================="$reset
echo -e $text"Downloading and verifying$header Debian 9.4.0$text Net Install ISO image..."$reset
...
sha256sum debian-9.4.0-amd64-netinst.iso
