...
DEBIAN_ISO="debian-live-$DEBIAN_VERSION-$DEBIAN_ARCHITECTURE-$DEBIAN_DESKTOP+nonfree.iso"
...
wget http://cdimage.debian.org/images/unofficial/non-free/images-including-firmware/current-live/$DEBIAN_ARCHITECTURE/iso-hybrid/$DEBIAN_ISO
wget http://cdimage.debian.org/images/unofficial/non-free/images-including-firmware/current-live/$DEBIAN_ARCHITECTURE/iso-hybrid/SHA256SUMS
wget http://cdimage.debian.org/images/unofficial/non-free/images-including-firmware/current-live/$DEBIAN_ARCHITECTURE/iso-hybrid/SHA256SUMS.sign
