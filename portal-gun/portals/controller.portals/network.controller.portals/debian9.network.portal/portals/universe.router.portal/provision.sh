...
##
## Universe Router Config Installer
##==========================================
...
echo -e $header"Multiverse OS: Universe Router Config Installer"$reset
echo -e $accent"==============================================="$reset
...
echo -e $text"Adding shorewall and dhcpd to startup default..."$reset
