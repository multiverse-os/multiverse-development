...
# Global Variables
###############################################################################
# TODO: This should be moved to its own file as with the palette so it can be
#       imported as needed and be edited in a single file.
#
###############################################################################
MV_USER="user"
MV_GROUP="libvirt"
...
assign_device_qemu_bridge_permissions(){
  ...
  # TODO: Copy the permission fix script verison to its own file and call it, since its useful on its own
